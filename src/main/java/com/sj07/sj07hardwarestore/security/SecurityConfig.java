package com.sj07.sj07hardwarestore.security;

import com.sj07.sj07hardwarestore.filter.CustomAuthorizationFilter;
import com.sj07.sj07hardwarestore.handler.CustomAccessDeniedHandler;
import com.sj07.sj07hardwarestore.handler.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request.requestMatchers("DELETE", "/auth/delete/**").hasAnyAuthority("DELETE:USER"));
